...
const char laserTagTopicLive[] = MQTT_USERNAME "/feeds/players.laser-tag-player-4";
const char laserTagTopicOutOfLife[] = MQTT_USERNAME "/feeds/death-count.death-count-4";
